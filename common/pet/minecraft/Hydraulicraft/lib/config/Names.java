...
public class Names {
	...
	public static final Name blockHydraulicPressurevat = new Name("Hydraulic pressure vat", "hydraulicPressureVat");
	public static final Name blockHydraulicMixer = new Name("Hydraulic mixer", "hydraulicMixer");
	public static final Name blockHydraulicFrictionPlate = new Name("Hydraulic friction plate", "hydraulicFrictionPlate");	
