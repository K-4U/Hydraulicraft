...
public class OreFoxium extends OreMineral implements IGlowBlock {

    private IIcon glowIcon;
    public OreFoxium() {
        super(Names.oreFoxium);
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegistry){
        ...
        glowIcon = iconRegistry.registerIcon(ModInfo.LID + ":" + Names.oreFoxium.unlocalized + "_glow");
    }
