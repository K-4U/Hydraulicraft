...
public class HCConfig extends Config {
    ...
    public void init() {
        ...
        configOptions.add(new ConfigOption("rubberPatchChance", 0.25).setCategory("worldgen").setComment("How big the chance is a log has a rubber "
                + "patch"));
        configOptions.add(new ConfigOption("maxRubberInTree", 1000).setCategory("worldgen").setComment("How much rubber a rubber patch max contains"
          + ". (respawns over time) This number is randomized and is the absolute max."));
