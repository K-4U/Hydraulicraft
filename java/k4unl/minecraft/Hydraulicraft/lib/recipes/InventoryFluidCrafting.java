...
public class InventoryFluidCrafting implements IFluidInventory {
   ...
   public boolean isItemValidForSlot(int slot, ItemStack itemStack) {
      return slot < getInternalSizeInventory();
   ...
   public boolean canInsertItem(int slot, ItemStack itemStack) {
      return getStackInSlot(slot) == null || itemStack != null && getStackInSlot(slot) != null && ItemStackUtils.canMergeStacks(getStackInSlot(slot), itemStack);
   }

   public boolean canExtractItem(int slot, ItemStack itemStack) {
      return slot >= getInternalSizeInventory() && inventoryResult.canExtract(slot - getInternalSizeInventory(), itemStack);
   }
