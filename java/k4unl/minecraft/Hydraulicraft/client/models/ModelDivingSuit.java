...
public class ModelDivingSuit extends ModelBiped {
    ...
    public ModelDivingSuit() {
        ...
        this.LeftLegPanel = new ModelRenderer(this, 110, 4);
        this.LeftLegPanel.setRotationPoint(-5.0F, 17.0F, -1.0F);
        this.LeftLegPanel.addBox(0.0F, 0.0F, 0.0F, 1, 2, 2, 0.0F);
        this.HelmetGlassRight = new ModelRenderer(this, 0, 9);
        this.HelmetGlassRight.setRotationPoint(-5.0F, -8.0F, -4.0F);
        this.HelmetGlassRight.addBox(0.0F, 0.0F, 0.0F, 1, 8, 2, 0.0F);
        this.RightYellowTank = new ModelRenderer(this, 22, 9);
        this.RightYellowTank.setRotationPoint(-5.25F, 2.5F, 3.0F);
        this.RightYellowTank.addBox(0.0F, 0.0F, 0.0F, 2, 10, 2, 0.0F);
        this.LeftArmPanel = new ModelRenderer(this, 60, 2);
        this.LeftArmPanel.setRotationPoint(-9.0F, 5.0F, -1.5F);
        this.LeftArmPanel.addBox(0.0F, 0.0F, 0.0F, 1, 3, 3, 0.0F);
        this.BackLeftUpperArm = new ModelRenderer(this, 118, 0);
        this.BackLeftUpperArm.setRotationPoint(-9.0F, 0.0F, 1.0F);
        this.BackLeftUpperArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.BackLeftLowerArm = new ModelRenderer(this, 84, 2);
        this.BackLeftLowerArm.setRotationPoint(-9.0F, 8.0F, 1.0F);
        this.BackLeftLowerArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.BackLeftLowerLeg = new ModelRenderer(this, 34, 21);
        this.BackLeftLowerLeg.setRotationPoint(-5.0F, 19.0F, 1.0F);
        this.BackLeftLowerLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.FrontLeftLowerLeg = new ModelRenderer(this, 30, 21);
        this.FrontLeftLowerLeg.setRotationPoint(-5.0F, 19.0F, -2.0F);
        this.FrontLeftLowerLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.HelmetBack = new ModelRenderer(this, 92, 0);
        this.HelmetBack.setRotationPoint(-4.0F, -8.0F, 4.0F);
        this.HelmetBack.addBox(0.0F, 0.0F, 0.0F, 8, 8, 1, 0.0F);
        this.FrontLeftBar = new ModelRenderer(this, 98, 9);
        this.FrontLeftBar.setRotationPoint(-1.5F, 1.0F, -3.0F);
        this.FrontLeftBar.addBox(0.0F, 0.0F, 0.0F, 1, 11, 1, 0.0F);
        this.FrontRightBar = new ModelRenderer(this, 102, 9);
        this.FrontRightBar.setRotationPoint(0.5F, 1.0F, -3.0F);
        this.FrontRightBar.addBox(0.0F, 0.0F, 0.0F, 1, 11, 1, 0.0F);
        this.LeftHand = new ModelRenderer(this, 0, 19);
        this.LeftHand.setRotationPoint(-8.0F, 12.0F, -2.0F);
        this.LeftHand.addBox(0.0F, 0.0F, 0.0F, 2, 1, 4, 0.0F);
        this.BackBottomBar = new ModelRenderer(this, 30, 19);
        this.BackBottomBar.setRotationPoint(-4.0F, 12.0F, 2.0F);
        this.BackBottomBar.addBox(0.0F, 0.0F, 0.0F, 8, 1, 1, 0.0F);
        this.TankFrontPlate = new ModelRenderer(this, 78, 9);
        this.TankFrontPlate.setRotationPoint(-2.5F, 1.0F, 2.0F);
        this.TankFrontPlate.addBox(0.0F, 0.0F, 0.0F, 5, 11, 1, 0.0F);
        this.LeftYellowTank = new ModelRenderer(this, 90, 9);
        this.LeftYellowTank.setRotationPoint(3.25F, 2.5F, 3.0F);
        this.LeftYellowTank.addBox(0.0F, 0.0F, 0.0F, 2, 10, 2, 0.0F);
        this.BottomRightLeg = new ModelRenderer(this, 8, 20);
        this.BottomRightLeg.setRotationPoint(4.0F, 12.0F, -2.0F);
        this.BottomRightLeg.addBox(0.0F, 0.0F, 0.0F, 1, 1, 4, 0.0F);
        this.FrontPanel = new ModelRenderer(this, 40, 0);
        this.FrontPanel.setRotationPoint(-2.0F, 2.5F, -3.5F);
        this.FrontPanel.addBox(0.0F, 0.0F, 0.0F, 4, 4, 1, 0.0F);
        this.FrontLeftShoulderBar = new ModelRenderer(this, 84, 0);
        this.FrontLeftShoulderBar.setRotationPoint(-8.0F, -1.0F, -2.0F);
        this.FrontLeftShoulderBar.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
        this.RightHand = new ModelRenderer(this, 110, 17);
        this.RightHand.setRotationPoint(6.0F, 12.0F, -2.0F);
        this.RightHand.addBox(0.0F, 0.0F, 0.0F, 2, 1, 4, 0.0F);
        this.HelmetLeftBack = new ModelRenderer(this, 32, 0);
        this.HelmetLeftBack.setRotationPoint(4.0F, -8.0F, -2.0F);
        this.HelmetLeftBack.addBox(0.0F, 0.0F, 0.0F, 1, 8, 6, 0.0F);
        this.FrontRightLowerLeg = new ModelRenderer(this, 122, 17);
        this.FrontRightLowerLeg.setRotationPoint(4.0F, 19.0F, -2.0F);
        this.FrontRightLowerLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.FrontGlow = new ModelRenderer(this, 54, 0);
        this.FrontGlow.setRotationPoint(-1.0F, 3.5F, -4.0F);
        this.FrontGlow.addBox(0.0F, 0.0F, 0.0F, 2, 2, 1, 0.0F);
        this.FrontRightUpperLeg = new ModelRenderer(this, 24, 3);
        this.FrontRightUpperLeg.setRotationPoint(4.0F, 13.0F, -2.0F);
        this.FrontRightUpperLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.TankHelmetPipe = new ModelRenderer(this, 24, 0);
        this.TankHelmetPipe.setRotationPoint(-1.5F, 0.0F, 3.0F);
        this.TankHelmetPipe.addBox(0.0F, 0.0F, 0.0F, 3, 1, 2, 0.0F);
        this.BackRightShoulderBar = new ModelRenderer(this, 110, 2);
        this.BackRightShoulderBar.setRotationPoint(5.0F, -1.0F, 1.0F);
        this.BackRightShoulderBar.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
        this.FrontTopBar = new ModelRenderer(this, 30, 16);
        this.FrontTopBar.setRotationPoint(-4.0F, 0.0F, -4.0F);
        this.FrontTopBar.addBox(0.0F, 0.0F, 0.0F, 8, 1, 2, 0.0F);
        this.FrontLeftUpperLeg = new ModelRenderer(this, 22, 21);
        this.FrontLeftUpperLeg.setRotationPoint(-5.0F, 13.0F, -2.0F);
        this.FrontLeftUpperLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.BackLeftUpperLeg = new ModelRenderer(this, 26, 21);
        this.BackLeftUpperLeg.setRotationPoint(-5.0F, 13.0F, 1.0F);
        this.BackLeftUpperLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.BackRightUpperLeg = new ModelRenderer(this, 28, 3);
        this.BackRightUpperLeg.setRotationPoint(4.0F, 13.0F, 1.0F);
        this.BackRightUpperLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
        this.BackRightLowerArm = new ModelRenderer(this, 106, 16);
        this.BackRightLowerArm.setRotationPoint(8.0F, 8.0F, 1.0F);
        this.BackRightLowerArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.setRotateAngle(BackRightLowerArm, 0.0F, 0.0F, -0.03385938748868999F);
        this.RightTankPipe = new ModelRenderer(this, 0, 0);
        this.RightTankPipe.setRotationPoint(-2.5F, 0.5F, 3.5F);
        this.RightTankPipe.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
        this.setRotateAngle(RightTankPipe, 0.0F, 0.0F, 0.7853981633974483F);
        this.HelmetGlassFront = new ModelRenderer(this, 109, 8);
        this.HelmetGlassFront.setRotationPoint(-4.0F, -8.0F, -5.0F);
        this.HelmetGlassFront.addBox(0.0F, 0.0F, 0.0F, 8, 8, 1, 0.0F);
        this.FrontBottomBar = new ModelRenderer(this, 30, 14);
        this.FrontBottomBar.setRotationPoint(-4.0F, 12.0F, -3.0F);
        this.FrontBottomBar.addBox(0.0F, 0.0F, 0.0F, 8, 1, 1, 0.0F);
        this.LeftFoot = new ModelRenderer(this, 54, 3);
        this.LeftFoot.setRotationPoint(-5.0F, 23.0F, -1.0F);
        this.LeftFoot.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F);
        this.RightFoot = new ModelRenderer(this, 38, 21);
        this.RightFoot.setRotationPoint(4.0F, 23.0F, -1.0F);
        this.RightFoot.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F);
        this.HelmetGlassLeft = new ModelRenderer(this, 6, 9);
        this.HelmetGlassLeft.setRotationPoint(4.0F, -8.0F, -4.0F);
        this.HelmetGlassLeft.addBox(0.0F, 0.0F, 0.0F, 1, 8, 2, 0.0F);
        this.FrontRightUpperArm = new ModelRenderer(this, 88, 2);
        this.FrontRightUpperArm.setRotationPoint(8.0F, 0.0F, -2.0F);
        this.FrontRightUpperArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.TankBackPlate = new ModelRenderer(this, 12, 9);
        this.TankBackPlate.setRotationPoint(-2.0F, 1.0F, 5.5F);
        this.TankBackPlate.addBox(0.0F, 0.0F, 0.0F, 4, 10, 1, 0.0F);
        this.FrontRightShoulderBar = new ModelRenderer(this, 110, 0);
        this.FrontRightShoulderBar.setRotationPoint(5.0F, -1.0F, -2.0F);
        this.FrontRightShoulderBar.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
        this.FrontLeftLowerArm = new ModelRenderer(this, 122, 0);
        this.FrontLeftLowerArm.setRotationPoint(-9.0F, 8.0F, -2.0F);
        this.FrontLeftLowerArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.HelmetTop = new ModelRenderer(this, 60, 0);
        this.HelmetTop.setRotationPoint(-4.0F, -8.9F, -4.0F);
        this.HelmetTop.addBox(0.0F, 0.0F, 0.0F, 8, 1, 8, 0.0F);
        this.RightArmPanel = new ModelRenderer(this, 51, 17);
        this.RightArmPanel.setRotationPoint(8.0F, 5.0F, -1.5F);
        this.RightArmPanel.addBox(0.0F, 0.0F, 0.0F, 1, 3, 3, 0.0F);
        this.FrontLeftUpperArm = new ModelRenderer(this, 34, 0);
        this.FrontLeftUpperArm.setRotationPoint(-9.0F, 0.0F, -2.0F);
        this.FrontLeftUpperArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.BackRightUpperArm = new ModelRenderer(this, 50, 14);
        this.BackRightUpperArm.setRotationPoint(8.0F, 0.0F, 1.0F);
        this.BackRightUpperArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.FrontRightLowerArm = new ModelRenderer(this, 56, 14);
        this.FrontRightLowerArm.setRotationPoint(8.0F, 8.0F, -2.0F);
        this.FrontRightLowerArm.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F);
        this.HelmetRightBack = new ModelRenderer(this, 46, 0);
        this.HelmetRightBack.setRotationPoint(-5.0F, -8.0F, -2.0F);
        this.HelmetRightBack.addBox(0.0F, 0.0F, 0.0F, 1, 8, 6, 0.0F);
        this.BackLeftShoulderBar = new ModelRenderer(this, 60, 0);
        this.BackLeftShoulderBar.setRotationPoint(-8.0F, -1.0F, 1.0F);
        this.BackLeftShoulderBar.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
        this.TankController = new ModelRenderer(this, 60, 9);
        this.TankController.setRotationPoint(-3.0F, 0.5F, 2.5F);
        this.TankController.addBox(0.0F, 0.0F, 0.0F, 6, 12, 3, 0.0F);
        this.LeftTankPipe = new ModelRenderer(this, 4, 0);
        this.LeftTankPipe.setRotationPoint(2.0F, 1.5F, 3.5F);
        this.LeftTankPipe.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
        this.setRotateAngle(LeftTankPipe, 0.0F, 0.0F, -0.7853981633974483F);
        this.BottomLeftLeg = new ModelRenderer(this, 44, 19);
        this.BottomLeftLeg.setRotationPoint(-5.0F, 12.0F, -2.0F);
        this.BottomLeftLeg.addBox(0.0F, 0.0F, 0.0F, 1, 1, 4, 0.0F);
        this.RightLegPanel = new ModelRenderer(this, 0, 4);
        this.RightLegPanel.setRotationPoint(4.0F, 17.0F, -1.0F);
        this.RightLegPanel.addBox(0.0F, 0.0F, 0.0F, 1, 2, 2, 0.0F);
        this.BackRightLowerLeg = new ModelRenderer(this, 18, 20);
        this.BackRightLowerLeg.setRotationPoint(4.0F, 19.0F, 1.0F);
        this.BackRightLowerLeg.addBox(0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F);
