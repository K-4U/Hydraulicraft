...
public class FluidOil extends Fluid {
    ...
    public FluidOil() {
        super(Names.fluidOil.unlocalized, new ResourceLocation(ModInfo.LID, "textures/blocks/oil_still"), new ResourceLocation(ModInfo.LID, "textures/blocks/oil_flowing"));
